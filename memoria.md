...
- Implementação LOCAL: `shared/fotograma-direction.js` seis pares documentados e `shared/fotograma-studio.js/css` com Prompts & uso, sistemas por etapa, prompt salvo, perfis/fontes e contagem local (não fatura). Assinatura / somente brief / diretor+fotografia.
