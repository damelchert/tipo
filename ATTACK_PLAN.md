...
- 22.3 (fila): mais efeitos/controles (halftone shapes da reticula, ascii-atlas, blur/sharpen, kaleido, curves), **Blend node** (2 frames → 1 = grafo real), persistência do espaço (IndexedDB), TipoAudio nas gravações (áudio no MP4), BPM phase-lock.
