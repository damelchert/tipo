...
- [ ] 21.8e — **"Modo Ficha"** (proposta pro Daniel): campos de texto livre opcionais por ponto (distância/ótica/DoF/textura/luz/grade) preenchíveis à mão, em branco = seletor/programa decide. Decidir UX antes de codar.
