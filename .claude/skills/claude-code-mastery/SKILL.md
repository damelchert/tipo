...
description: "Squad especialista em todas as dimensões do Claude Code: hooks, skills, subagents, MCP, plugins, agent teams, customização, integração com projetos, roadmap tracking, e AIOS-core architecture. 8 agentes cobrindo full-spectrum Claude Code expertise."
---

# claude-code-mastery

Squad especialista em todas as dimensões do Claude Code: hooks, skills, subagents, MCP, plugins, agent teams, customização, integração com projetos, roadmap tracking, e AIOS-core architecture. 8 agentes cobrindo full-spectrum Claude Code expertise.

## When to Apply

### Must Use
- Configuração avançada de Claude Code
- Criação de hooks, skills e subagents
- Integração com MCP servers
- Plugins e marketplace
- Agent teams e orquestração
- Debugging de configurações Claude Code
